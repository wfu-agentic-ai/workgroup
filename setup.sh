...
#
# See: https://wfu-agentic-ai.github.io/workgroup/tutorials/shell-configuration.html
...
if ! command -v brew &>/dev/null; then
  ...
  if confirm "Install Homebrew now?"; then
    ...
    echo "  https://wfu-agentic-ai.github.io/workgroup/tutorials/shell-configuration.html#the-setup-script"
    echo ""
    exit 1
  fi
else
